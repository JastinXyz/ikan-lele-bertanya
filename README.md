...
Projek ini akan memberikan beberapa text random yang ada di file [data.js](https://github.com/JastinXyz/ikan-lele-bertanya/blob/main/kamus.json). Sangat welcome jika ingin menambah beberapa text baru dengan cara fork repo ini dan buka pull request baru 👌.
